...
<div>
  ...
  <div class="flex gap-x-3 relative group rounded-lg hover:bg-gray-100 dark:hover:bg-white/10">
    <a class="z-[1] absolute inset-0" href="https://wa.me/27710361173"></a>
  ...
  <!-- Item -->
  <div class="flex gap-x-3 relative group rounded-lg hover:bg-gray-100 dark:hover:bg-white/10">
    <a class="z-[1] absolute inset-0" href="https://wa.me/0710361173"></a>
    ...
    <div class="grow p-2 pb-8">
      ...
      <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">
        Do you need a Learners' licence or a Drivers' licence?
      </p>
    </div>
    <!-- End Right Content -->
  </div>
  ...
  <div class="flex gap-x-3 relative group rounded-lg hover:bg-gray-100 dark:hover:bg-white/10">
    ...
    <div class="grow p-2 pb-8">
      ...
      <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">
        For just a learner's licence, add to cart and checkout!
      </p>
    </div>
    <!-- End Right Content -->
  </div>
...
<div>
  ...
  <div class="flex gap-x-3 relative group rounded-lg hover:bg-gray-100 dark:hover:bg-white/10">
    ...
    <div class="grow p-2 pb-8">
      <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">
        Find all driving packages in the next page Lessons.
      </p>
    </div>
    <!-- End Right Content -->
  </div>
  ...
  <div class="flex gap-x-3 relative group rounded-lg hover:bg-gray-100 dark:hover:bg-white/10">
    ...
    <div class="grow p-2 pb-8">
      ...
      <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">
        An instructor will contact you shortly after your purchase.
      </p>
  ...
  <div class="flex gap-x-3 relative group rounded-lg hover:bg-gray-100 dark:hover:bg-white/10">
    ...
    <div class="grow p-2 pb-8">
      <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">
        Press on this and open chat with your instructor!
      </p>
  ...
  <div class="flex gap-x-3 relative group rounded-lg hover:bg-gray-100 dark:hover:bg-white/10">
    ...
    <div class="grow p-2 pb-8">
      ...
      <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">
        Enter your pick up details & Scedule appropriate times for meet-ups and lessons.
      </p>
      <button type="button" class="mt-1 -ms-1 p-1 relative z-10 inline-flex items-center gap-x-2 text-xs rounded-lg border border-transparent text-gray-500 hover:bg-white hover:shadow-sm disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-800">
