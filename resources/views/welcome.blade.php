...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>WaterPlus Driving School</title>
        ...
        <style>
            ...
            ::after,::before{--tw-content:''}:host,html{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;tab-size:4;
            ...
            body{margin:0;line-height:inherit}hr{height:0;color:inherit;border-top-width:1px}abbr:where([title]){-webkit-text-decoration:underline dotted;
            text-decoration:underline dotted}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}b,strong{font-weight:bolder}code,kbd,pre,samp{font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;
            font-feature-settings:normal;font-variation-settings:normal;font-size:1em}small{font-size:80%}
            sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit;border-collapse:collapse}
...
<!--
        This is the Sun item, the red one on the left top corner
...
<!-- This is where we want our logo to go   -->

                            <img src="{{ asset('logo/croppedlongwaterpluslogo.jpeg') }}" width="1000px" height="400px">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img
                                        ...
                                        src="{{ asset('logo/womandrivingschool.jpg') }}"
...
<!-- This is the icon inside the oval shape, this we want to populate with a massive "L" icon symbolizing a Learners licence  -->
                                          

                                            <img src="{{ asset('icon/person-vcard.svg') }}" width="30px">


                                        
                                        </div>
<!-- The very big, on the left sheet, discription of a learners licence and what we offer at our driving school  -->
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black">Learners Licence</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                            At Waterplus Driving School, we offer a comprehensive range of services tailored to your needs. 
                                            Whether you're just starting out and seeking your learner's license, 
                                            we provide expert guidance to help you obtain it quickly and affordably, with a guaranteed path to success.
                                            </p>
                                        </div>
                                    </div>
...
<!-- The first sheet on the right hand side, this will detail what our code 08 entails            -->
                            <a
                                href="{{ route('register') }}"
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
<!-- Code 8, the car front -->
                                <img src="{{ asset('icon/car-front.svg') }}" width="30px">
                                
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Code 08</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                    Whether you're aiming to obtain a driver's license for a light motor vehicle, 
                                    you can trust our team of qualified instructors to provide the highest level of professionalism. 
                                    With our expert guidance, we ensure you're fully prepared to pass your driving test on the first attempt.
                                    </p>
                                </div>

                                <svg class="size-6 shrink-0 self-center stroke-[#FF2D20]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75"/></svg>
                            </a>
<!--  The is the middle sheet on the right hand side, it will entail the code 10 and what that entails     -->
                            <a
                               href="{{ route('register') }}"
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10"
                            >
...
<!-- This is the Code 10 flatbed icon, where we talk about code 10 licences  -->
                                <img src="{{ asset('icon/truck-flatbed.svg') }}" width="30px">
                                
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Code 10</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                    Trust Waterplus Driving School to provide expert lessons for medium to heavy motor vehicles, 
                                    including trucks. With our comprehensive training, competitive pricing, and convenient truck rentals, 
                                    we guarantee a stress-free experience and a first-time pass with confidence—no hassle, just results.
                                    </p>
                                </div>
...
<!-- This is the icon spot for the last icon, a big truck  -->        
                                   
                                   <img src="{{ asset('icon/truck.svg') }}" width="30px">

                                </div>
<!-- This is the last sheet on the right hand side, it is for code 14       -->
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Code 14</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                    If you're seeking expert driving lessons for larger vehicles, such as trailer-hauling trucks, 
                                    Waterplus is here to serve you. With our meticulous attention to detail and top-tier professional training, 
                                    we’re committed to ensuring you pass your test on the first attempt—confidently and without question.
                                        <!--
                                        Laravel's robust library of first-party tools and libraries, such as 
                                        <a href="https://forge.laravel.com" 
                                        class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">Forge</a>, <a href="https://vapor.laravel.com" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">
                                        Vapor</a>, <a href="https://nova.laravel.com" 
                                        class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">Nova</a>, <a href="https://envoyer.io" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">
                                        Envoyer</a>, and <a href="https://herd.laravel.com" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">Herd</a> help you take your projects to the next level. Pair them with powerful open source libraries like 
                                        <a href="https://laravel.com/docs/billing" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">Cashier</a>, <a href="https://laravel.com/docs/dusk" 
                                        class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">Dusk</a>, <a href="https://laravel.com/docs/broadcasting" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">
                                        Echo</a>, <a href="https://laravel.com/docs/horizon" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">
                                        Horizon</a>, <a href="https://laravel.com/docs/sanctum" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">Sanctum</a>, 
                                        <a href="https://laravel.com/docs/telescope" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]">Telescope</a>, and more.
                                        -->
                                    </p>
                                </div>
                            </div>
