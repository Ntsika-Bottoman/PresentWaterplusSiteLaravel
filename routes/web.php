...
// - - - This is the code that make the Location "button" clickerable & visible - - - //
Route::view('create', 'create')
->middleware(['auth', 'verified'])
->name('create');
// - - - The end of such code for location - - - //

// - - - The checkout code to pass the price to YOCO - - - //
Route::post('/checkout', [RequestController::class, 'addPost'])->name('checkout');
// - - - The end of the POST call to the Yoco API - - - //